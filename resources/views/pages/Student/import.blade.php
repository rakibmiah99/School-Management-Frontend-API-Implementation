...
<section class="section-importStudent--heading u-padding-lg">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <h2 class="heading--main">Import Student</h2>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 ms-auto text-end">
                <a class="btn btn-text px-4 py-3" href="../assets/files/import_students.csv">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form  method="post" action="/student/import/save" enctype="multipart/form-data" >
                            @csrf
                            <div class="row">
                                <div class="col-md-3">
                                    <select name="class_id" id="selectClass">
                                        ...
                                        @foreach($classes as $class)
                                            <option class="dropdown-item" value="{{$class->id}}">{{$class->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-3">
                                    <select name="section_id" id="sectionList">
                                        <option class="dropdown-item" value="">Select Section*</option>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                    <input name="file" id="fileid" type="file" hidden />
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-text mt-4">Bulk Import Student</button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
@section('scripts-last')
    ...
    <script>
        ...
        let selectSection = $('#sectionList');
        // Selectize(selectClass);
