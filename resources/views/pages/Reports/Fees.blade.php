...
@section('MainContent')
    ...
    <section class="section-accountReport--heading u-padding-lg">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="heading--main">Fees Report</h2>
                </div>
            </div>
        </div>
    </section>
...
@section('scripts-last')
    ...
    <script>
        ...
        $('#csvBtn').on('click', function (e) {
            ...
            window.location.href = `/reports/fees/export-csv/${startDate}/${endDate}`
        });
        ...
        $('#pdfBtn').on('click', function (e) {
            ...
            let startDate =$('#accountsReportRange').data('daterangepicker').startDate.format('YYYY-MM-DD');
            let endDate = $('#accountsReportRange').data('daterangepicker').endDate.format('YYYY-MM-DD');
            window.location.href = `/reports/fees/export-pdf/${startDate}/${endDate}`
        });
        ...
        $('#filterBtn').on('click', function () {
            ...
            let endDate = $('#accountsReportRange').data('daterangepicker').endDate.format('YYYY-MM-DD');
            PreloaderON();
            axios.get(`/reports/fees/get/${startDate}/${endDate}`)
        ...
        function Item(item, index) {
            table.append(`
                <tr>
                    ...
                    <td>
                      ${(item.student_data != null) ? item.student_data.name : "-"}
                    </td>
                    <td>Student</td>
