                        ...
                        <div class="card-body">
                            <form id="CreateForm" class="mb-3">
                                <input
                                    ...
                                    required
                                />
                                <button type="submit" class="btn btn-text">✔ SAVE EXAM TYPE</button>
                            </form>
                        </div>
                    </div>
                </div>
...
@section('scripts-last')
    ...
    <script>
        ...
        createForm.on('submit', function (e) {
            ...
            axios.post('/examination/add', formData)
        ...
        updateForm.on('submit', function (e) {
            ...
            let formData = new FormData();
            formData.append('name', examType);
            axios.post('/examination/update/'+id, formData)
            .then(function (response) {
                // PreloaderOFF();
                if(response.status === 200 && response.data.status == true){
        ...
        table.on('click', '.delete', function () {
            ...
            axios.get('/examination/delete/'+id)
            .then(function (response) {
                if(response.status === 200 && response.data.status == true){
        ...
        table.on('click', '.edit', function () {
            ModalLoaderON();
            let id = $(this).attr('data-id');
            axios.get('/examination/get-single/'+id)
            .then(function (response) {
