...
@section('MainContent')
    ...
    <section class="section-examType--heading u-padding-lg">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="heading--main">Fees Type</h2>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-title">
                            <h3 class="heading--sub">Add Fees Type</h3>
                        </div>
                        <div class="card-body">
                            <form id="CreateForm" class="mb-3">
                                <input
                                    ...
                                    required
                                />
                                <button type="submit" class="btn btn-text">✔ SAVE Fees TYPE</button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-title">
                            <h3 class="heading--sub">Fees List</h3>
                        </div>
                        <div class="card-body">
                            <table class="table">
                                <thead>
