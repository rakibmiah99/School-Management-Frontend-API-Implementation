...
@section('MainContent')
    ...
    <section class="section-examType--heading u-padding-lg">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="heading--main">Income Type</h2>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-title">
                            <h3 class="heading--sub">Add Income Type</h3>
                        </div>
                        <div class="card-body">
                            <form id="CreateForm" class="mb-3">
                                <input
                                    ...
                                    required
                                />
                                <button type="submit" class="btn btn-text">✔ SAVE INCOME </button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-title">
                            <h3 class="heading--sub">Income Type List</h3>
                        </div>
                        <div class="card-body">
                            <table class="table">
                                <thead>
...
@section('scripts-last')
    ...
    <script>
        ...
        createForm.on('submit', function (e) {
            ...
            axios.post('/accounts/income-type/add', formData)
        ...
        updateForm.on('submit', function (e) {
            ...
            let formData = new FormData();
            formData.append('name', examType);
            axios.post('/accounts/income-type/update/'+id, formData)
                .then(function (response) {
                    // PreloaderOFF();
                    if(response.status === 200 && response.data.status == true){
                        GetAll();
        ...
        table.on('click', '.delete', function () {
            ...
            axios.get('/accounts/income-type/delete/'+id)
                .then(function (response) {
                    if(response.status === 200 && response.data.status == true){
                        GetAll();
                    }
        ...
        table.on('click', '.edit', function () {
            ModalLoaderON();
            let id = $(this).attr('data-id');
            axios.get('/accounts/income-type/get-single/'+id)
                .then(function (response) {
        ...
        GetAll();
        function GetAll() {
            axios.get('/accounts/income-type/get-all')
                .then(function (response) {
                    PreloaderOFF();
                    if(response.status === 200){
                        table.empty();
